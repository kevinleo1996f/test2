...
export default function MarketplaceTab({
  ...
  // Electricity-themed flicker icons
  ...
  const renderMarketplace = () => (
    <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.marketplaceHeader}>
        <View style={{ backgroundColor: '#E8F5E9', borderRadius: 12, padding: 12, width: '100%' }}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Animated.View style={{ transform: [{ scale: pulse }, { translateY: floatY }] }}>
              <Ionicons name="flash" size={28} color="#2E7D32" />
            </Animated.View>
      ...
      {isLoading ? (
        ...
        (showAllProviders ? electricityProviders : electricityProviders.slice(0, 4)).map((provider, index) => (
          <TouchableOpacity
      ...
      {/* Discover more / Show less buttons */}
      {!showAllProviders && electricityProviders.length > 3 ? (
        <View style={{ alignItems: 'center', marginTop: 8 }}>
          <TouchableOpacity style={styles.smallButton} onPress={() => setShowAllProviders(true)}>
            <Text style={styles.smallButtonText}>Discover more providers</Text>
          </TouchableOpacity>
        </View>
      ) : null}
      {showAllProviders && electricityProviders.length > 3 ? (
        <View style={{ alignItems: 'center', marginTop: 8 }}>
          <TouchableOpacity style={styles.smallButton} onPress={() => setShowAllProviders(false)}>
